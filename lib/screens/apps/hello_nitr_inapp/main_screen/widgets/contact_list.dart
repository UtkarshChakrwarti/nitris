...
import 'package:nitris/screens/apps/hello_nitr_inapp/main_screen/widgets/expanded.dart';
...
class ContactListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Dismissible(
      ...
      background:
          _buildSwipeBackgroundLeft(CupertinoIcons.phone_solid, 'Make Call'),
      secondaryBackground: _buildSwipeBackgroundRight(
          CupertinoIcons.person_crop_circle_fill, 'View Profile'),
